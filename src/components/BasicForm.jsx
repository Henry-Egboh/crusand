      ...
      <form onSubmit={handleSubmit}>
        <fieldset className="fieldset">
          ...
          <section className="input-wrapper">
            ...
            {errors.username && touched.username ? (
              <p className="error-display">{errors.username}</p>
            ) : (
              ""
            )}
          </section>
          ...
          <section className="input-wrapper">
            ...
            <div>
              <input
                id="age"
                className={
                  errors.age && touched.age ? "form-errors input" : "input"
                }
                type="number"
            ...
            {errors.age && touched.age ? (
              <p className="error-display">{errors.age}</p>
            ) : (
              ""
            )}
          </section>
          ...
          <section className="input-wrapper">
            ...
            <div>
              <select
                className={
                  errors.city && touched.city ? "form-errors input" : "input"
                }
                name="city"
                values={values.city}
                onChange={handleChange}
            ...
            {errors.city && touched.city ? (
              <p className="error-display">{errors.city}</p>
            ) : (
              ""
            )}
          </section>
          ...
          <section className="input-wrapper">
            ...
            {errors.country && touched.country ? (
              <p className="error-display">{errors.country}</p>
            ) : (
              ""
            )}
          </section>
          ...
          <section className="input-wrapper">
            ...
            {errors.confirmPassword && touched.confirmPassword ? (
              <p className="error-display">{errors.confirmPassword}</p>
            ) : (
              ""
            )}
            {/* toggle checkbox */}
          ...
          <section className="checkbox input-wrapper">
            ...
            >
              I acknowledge that I have read and agreed to the terms of service.
            </label>
            {errors.agree ? (
              <p className="error-display">{errors.agree}</p>
            ) : (
              ""
            )}
          </section>
